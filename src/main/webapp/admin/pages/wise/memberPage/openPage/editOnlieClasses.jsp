			...
			$.ajax({
				...
				success:function(data){
					if(data.success == true){
						...
						$("#togetherClassesCompany").val(data.data.onlineClass.freeco_company);
						$("#planHostAddress").val(data.data.onlineClass.freeco_address);
						$("#togetherClassesStartDate").val(data.data.onlineClass.freeco_tstartDate);
						$("#togetherClassesEndDate").val(data.data.onlineClass.freeco_tendDate); 
						$("#hostDate").val(data.data.onlineClass.freeco_hostData);
						$("#classesEndDate").val(data.data.onlineClass.freeco_endDate);
						$("#maxClassesNumber").val(data.data.onlineClass.freeco_maxNumber);
