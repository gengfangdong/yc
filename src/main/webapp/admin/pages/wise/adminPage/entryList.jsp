	...
	<body class="hold-transition skin-blue sidebar-mini">
																				...
																				<table id="branchPage" class="table table-bordered table-hover example1_x" style="margin-top: 20px!important;">
																					<thead>
																						<tr>
																							...
																							<th style="text-align: center;">报名类别</th>
		...
		<script>
			$(function() {
				...
				var branchPage = $('#branchPage').DataTable({
					...
					"autoWidth": false,
					ajax: {
		                url: "<%=request.getContextPath()%>/Apply/getApplyshow"
		            },
		            serverSide: true,
		            columns: [
		            ...
		            "aoColumnDefs":[{"targets":1,
		            	visible:false
	                        ...
	                        render: function(data, type, row) {
	                            var html ='<a id=\"show\" href=\"#\" onclick=\"addBranch(this,\''+row.applyshow_id+'\');\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\" onclick=\"addBranch(this,\''+row.applyshow_id+'\');\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"del\"  href=\"#\" onclick=\"addBranch(this,\''+row.applyshow_id+'\');\">删除</a></p>';
	                            return html;
	                        }
	                    }], 
		...
		<script type="text/javascript">
			...
			function addBranch(obj,id){
				...
				var sStates = obj.parentElement.parentElement.children[1].innerHTML;
				if(sStates == '单位'){
                    if(sText=='查看'){
                        layui.use('layer',function(){
                            ...
                            layer.open({
                                ...
                                maxmin: true,
                                offset: [100,200] ,
                                content: 'openPage/showEntryListByCompany.jsp?applyshow_id='+id,
                        ...
                        layui.use('layer',function(){
                            ...
                            layer.open({
                                ...
                                maxmin: true,
                                offset: [100,200] ,
                                content: 'openPage/updateEntryListByCompany.jsp?applyshow_id='+id,
                                zIndex: layer.zIndex, //重点1
                                success: function(layero){
                                    layer.setTop(layero); //重点2
                                }
                    ...
                    if(sText=='查看'){
                        layui.use('layer',function(){
                            ...
                            layer.open({
                                ...
                                maxmin: true,
                                offset: [100,200] ,
                                content: 'openPage/showEntryListByOne.jsp?applyshow_id='+id,
                                zIndex: layer.zIndex, //重点1
                                success: function(layero){
                                    layer.setTop(layero); //重点2
                                }
                        ...
                        layui.use('layer',function(){
                            ...
                            layer.open({
                                ...
                                maxmin: true,
                                offset: [100,200] ,
                                content: 'openPage/changeEntryByOne.jsp?applyshow_id='+id,
                                zIndex: layer.zIndex, //重点1
                                success: function(layero){
                                    layer.setTop(layero); //重点2
                                }
