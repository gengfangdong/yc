	...
	<th>创建时间</th>
									...
									<tbody>
										...
										<tr>
											...
											<td class="tableRightTd"><input class="onlineInput" id="byOneIDNum" type="text" maxlength="18" placeholder="请输入您的16位身份证号码" /></td>
											<!-- <td>2012-10-01</td> -->
										</tr>
										<tr>
		...
		<script>
			function byOneSubmit() {
				...
				$.ajax({
					...
					data: {
						"project_id":"Project0628afcfdc344240abe971bbcdaf0cf5",
						"name": names,
						"sex": sex,
						"brithday": birthday,
