	...
	<div class="wrapper">
						...
						<li class="treeview active">
							...
							<ul class="treeview-menu treeUl">
								...
								<li>
									...
									<ul class="treeview-menu menu_tree">
										<li>
											<a href="cultureSystem.jsp"style="color: #ffffff;" ><i class="fa fa-square-o"></i> 培养体系</a>
										</li>
										<li>
			...
			<div class="content-wrapper">
				<section class="content-header">
					<h1>项目概况<small>培养体系</small></h1>
					<ol class="breadcrumb">
						<li><i class="fa fa-dashboard"></i> 首页</li>
						<li> 项目概况</li>
						<li class="active">培养体系</li>
					</ol>
				</section>
														...
														<div class="tab-pane fade in active" id="taxpayerAnalysis" style="margin-top: 5px;" >
															<div class="form-group" style="width: 100%;margin-top: 5px;height: 32px;line-height: 32px;margin-bottom: 0;">
																<div class="col-sm-10" style="height: 32px;line-height: 32px;">
																	<ul class="f-sort-ul">
																		<li><button class="add" onclick="addCulture(this);">新增</button></li>
																	</ul>
																</div>
															</div>
															...
															<div class="row">
																<div class="col-sm-12 col-md-12">
																	<div class="table-responsive table-responsive_vis" id="sample-table-1" style="padding-left: 10px;padding-right: 10px;">
																		<table id="culturePage" class="table table-bordered table-hover example1_x" style="margin-top: 20px!important;">
																			<thead>
																				<tr>
																					<th style="text-align: center;">序号</th>
																					<th style="text-align:center;">培养id</th>
		...
		<script>
			$(function() {
				...
				var culturePage = $('#culturePage').DataTable({
					...
					"autoWidth": false,
					ajax: {
		                url: "<%=request.getContextPath()%>/Culture/getlist"
		            },
		            serverSide: true,
		            columns: [
		            ...
		            "aoColumnDefs":[{"targets":1,
		            	visible:false
	                        ...
	                        render: function(data, type, row) {
	                            var html ='<a id=\"show\" href=\"#\" onclick=\"addCulture(this,\''+row.culture_id+'\');\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\" onclick=\"addCulture(this,\''+row.culture_id+'\');\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"del\"  href=\"#\" onclick=\"addCulture(this,\''+row.culture_id+'\');\">删除</a></p>';
	                            return html;
	                        }
	                    }], 
		...
		<script type="text/javascript">
			...
			$('#culturePage tbody').on( 'click', 'a#edit', function () {
  					 var data=$('#culturePage').DataTable().row($(this).parents('tr')).data();
 					  alert("查看修改："+data.tenantName +","+ data.id );
 			} );
	        function addCulture(obj,id){
		        ...
		        if(sText=='新增'){
		        	layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/addCulture.jsp',
		        	...
		        	layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/showCulture.jsp?culture_id='+id,
					        zIndex: layer.zIndex, //重点1
					        success: function(layero){
					          layer.setTop(layero); //重点2
					        }
		        	...
		        	layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/updateCulture.jsp?culture_id='+id,
					        zIndex: layer.zIndex, //重点1
					        success: function(layero){
					          layer.setTop(layero); //重点2
					        }
		        	...
		        	$.ajax({
						url : '<%=request.getContextPath()%>/Culture/deleteCulture',
						type : 'post',
						dataType:"json",
						data:{
							Culture_id:id
