						...
						<li class="treeview active">
							...
							<ul class="treeview-menu treeUl">
								...
								<li>
									...
									<ul class="treeview-menu menu_tree">
										<li>
											<a href="projectList.jsp" style="color: #ffffff;"><i class="fa fa-square-o"></i> 项目列表</a>
										</li>
										<li>
		            ...
		            "aoColumnDefs":[{"targets":1,
		            	visible:false
	                        ...
	                        render: function(data, type, row) {
	                            var html ='<a id=\"show\" href=\"#\" onclick=\"addBranch(this,\''+row.project_id+'\');\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\" onclick=\"addBranch(this,\''+row.project_id+'\');\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"del\"  href=\"#\" onclick=\"addBranch(this,\''+row.project_id+'\');\">删除</a></p>';
	                            return html;
	                        }
	                    }], 
				...
				if(sText=='新增'){
					layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/addProjectList.jsp',
					...
					layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/showProject.jsp?project_id='+id,
					        zIndex: layer.zIndex, //重点1
					        success: function(layero){
					          layer.setTop(layero); //重点2
					        }
					...
					layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/updateProject.jsp?project_id='+id,
					        zIndex: layer.zIndex, //重点1
					        success: function(layero){
					          layer.setTop(layero); //重点2
					        }
		        	...
		        	$.ajax({
						url : '<%=request.getContextPath()%>/Project/deleteProject',
						type : 'post',
						dataType:"json",
						data:{
							Project_id:id
