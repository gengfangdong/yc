...
<html>
	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
							...
							<ul class="treeview-menu treeUl">
								...
								<li>
									...
									<ul class="treeview-menu menu_tree">
										...
										<li>
											<a href="taxCollectionFund.jsp" style="color: #ffffff;"><i class="fa fa-square-o"></i> 领税基金</a>
										</li>
										<li>
			...
			<div class="content-wrapper">
				<section class="content-header">
					<h1>项目概况 <small>领税基金</small></h1>
					<ol class="breadcrumb">
						<li><i class="fa fa-dashboard"></i> 首页</li>
						<li> 项目概况</li>
						<li class="active">领税基金</li>
					</ol>
				</section>
														...
														<div class="tab-pane fade in active" id="taxpayerAnalysis" style="margin-top: 5px;">
															<div class="form-group" style="width: 100%;margin-top: 5px;height: 32px;line-height: 32px;margin-bottom: 0;">
																<div class="col-sm-10" style="height: 32px;line-height: 32px;">
																	<ul class="f-sort-ul">
																		<li><button class="add" onclick="addTax(this);">新增</button></li>
																	</ul>
																</div>
															</div>
															...
															<div class="row">
																<div class="col-sm-12 col-md-12">
																	<div class="table-responsive table-responsive_vis" id="sample-table-1" style="padding-left: 10px;padding-right: 10px;">
																		<table id="taxPage" class="table table-bordered table-hover example1_x" style="margin-top: 20px!important;">
																			<thead>
																				<tr>
																			...
																			<!-- <tbody>
																				<tr>
																					...
																					<td>待发布</td>
																					<td>
																						<a href="#" onclick="addTax(this);">查看</a>
																						<a href="#" onclick="addTax(this);">修改</a>
		...
		<script>
			$(function() {
				...
				var taxPage = $('#taxPage').DataTable({
					...
					"autoWidth": false,
					ajax: {
						url: "<%=request.getContextPath()%>/Tax/getlist"
					},
					serverSide: true,
					columns: [
					...
					"aoColumnDefs": [{
						...
						/* //设置列的属性，此处设置第一列不排序
								                      {"targets":5,
								                         "data": null,
								                        "bSortable": false,
								                        "defaultContent": "<p>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"show\" href=\"#\" onclick=\"addTax(this);\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"del\"  href=\"#\">删除</a></p>"
								              }, */
						{ //倒数第一列
							"targets": -1,
							"bSortable": false,
							render: function(data, type, row) {
								var html = '<a id=\"show\" href=\"#\" onclick=\"addTax(this,\'' + row.tax_id + '\');\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\" onclick=\"addTax(this,\'' + row.tax_id + '\');\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"del\"  href=\"#\" onclick=\"addTax(this,\'' + row.tax_id + '\');\">删除</a></p>';
								return html;
							}
						}
					],
		...
		<script type="text/javascript">
			...
			$('#taxPage tbody').on('click', 'a#edit', function() {
				var data = $('#taxPage').DataTable().row($(this).parents('tr')).data();
				alert("查看修改：" + data.tenantName + "," + data.id);
			});

			function addTax(obj, id) {
				...
				if(sText == '新增') {
					...
					layui.use('layer', function() {
						...
						layer.open({
							...
							maxmin: true,
							offset: [100, 200],
							content: 'openPage/showTax.jsp?tax_id=' + id,
							zIndex: layer.zIndex, //重点1
							success: function(layero) {
								layer.setTop(layero); //重点2
							}
					...
					layui.use('layer', function() {
						...
						layer.open({
							...
							maxmin: true,
							offset: [100, 200],
							content: 'openPage/updateTax.jsp?tax_id=' + id,
							zIndex: layer.zIndex, //重点1
							success: function(layero) {
								layer.setTop(layero); //重点2
							}
					...
					$.ajax({
						url: '<%=request.getContextPath()%>/Tax/deleteTax',
						type: 'post',
						dataType: "json",
						data: {
							Tax_id: id
