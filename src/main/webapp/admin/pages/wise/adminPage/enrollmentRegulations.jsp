		...
		<div class="wrapper">
							...
							<ul class="treeview-menu treeUl">
								...
								<li>
									...
									<ul class="treeview-menu menu_tree">
										...
										<li>
											<a href="enrollmentRegulations.jsp" style="color: #ffffff;"><i class="fa fa-square-o"></i> 招生简章</a>
										</li>
									</ul>
								</li>
							</ul>
			...
			<div class="content-wrapper">
				<section class="content-header">
					<h1>在职研 <small>招生规章</small></h1>
					<ol class="breadcrumb">
						<li><i class="fa fa-dashboard"></i> 首页</li>
						<li>在职研</li>
						<li class="active">招生规章	</li>
					</ol>
				</section>
																		...
																		<table id="newsPage" class="table table-bordered table-hover example1_x" style="margin-top: 20px!important;">
																			<thead>
																				<tr>
																					...
																					<th style="text-align:center;">通知公告id</th>
		...
		<script>
			$(function() {
				...
				var newsPage = $('#newsPage').DataTable({
					...
					"autoWidth": false,
					ajax: {
		                url: "<%=request.getContextPath()%>/Rules/getlist"
		            },
		            serverSide: true,
		            columns: [
		            ...
		            "aoColumnDefs":[{"targets":1,
		            	visible:false
	                        ...
	                        render: function(data, type, row) {
	                            var html ='<a id=\"show\" href=\"#\" onclick=\"addNews(this,\''+row.rules_id+'\');\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\" onclick=\"addNews(this,\''+row.rules_id+'\');\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"del\"  href=\"#\" onclick=\"addNews(this,\''+row.rules_id+'\');\">删除</a></p>';
	                            return html;
	                        }
	                    }], 
		        ...
		        if(sText=='新增'){
		        	...
		        	layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/showRules.jsp?rules_id='+id,
					        zIndex: layer.zIndex, //重点1
					        success: function(layero){
					          layer.setTop(layero); //重点2
					        }
		        	...
		        	layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/updateRules.jsp?rules_id='+id,
					        zIndex: layer.zIndex, //重点1
					        success: function(layero){
					          layer.setTop(layero); //重点2
					        }
		        	...
		        	$.ajax({
						url : '<%=request.getContextPath()%>/Rules/deleteRules',
						type : 'post',
						dataType:"json",
						data:{
							Rules_id:id
