	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
							...
							<ul class="treeview-menu treeUl">
								...
								<li>
									...
									<ul class="treeview-menu menu_tree">
										...
										<li>
											<a href="fileTab.jsp" style="color: #ffffff;"><i class="fa fa-square-o"></i> 附件中心</a>
										</li>
									</ul>
								</li>
								<li>
			...
			<div class="content-wrapper">
				<section class="content-header">
					<h1>资源管理 <small>附件中心</small></h1>
					<ol class="breadcrumb">
						<li><i class="fa fa-dashboard"></i> 首页</li>
						<li> 资源管理</li>
						<li class="active">附件中心</li>
					</ol>
				</section>
		...
		<script type="text/javascript">
			...
			layui.use('table', function(){
			  ...
			  table.render({
			    elem: '#LAY_table_user',
			    url: '<%=request.getContextPath()%>/Filetab/getlistBypage',
			    cols: [[
				  {type:'numbers',title:"序号"},
			      {field:'filename', title: '文件名'},
			      {field:'fileold', title: '文件'},
			  ...
			  table.on('tool(user)', function(obj){
			    ...
			    if(obj.event === 'detail'){
			    	layer.open({
						...
						maxmin: true,
						offset: ['10%', '15%'],
						content: 'openPage/showfileTab.jsp?file_id='+data.fileid,
			      	...
			      	layer.confirm('确定删除此附件?', function(index){
			      		$.ajax({
							url : '<%=request.getContextPath()%>/Filetab/deleteFile',
							type : 'post',
							dataType:"json",
							data:{
								fileid:data.fileid
			    	...
			    	layer.open({
						...
						maxmin: true,
						offset: ['10%', '15%'],
						content: 'openPage/updatefileTab.jsp?file_id='+data.fileid,
						zIndex: layer.zIndex, //重点1
						success: function(layero) {
							layer.setTop(layero); //重点2
						}
				...
				if(sText == '新增') {
					layui.use('layer', function() {
						...
						layer.open({
							...
							maxmin: true,
							offset: ['10%', '15%'],
							content: 'openPage/addfileTab.jsp',
							zIndex: layer.zIndex, //重点1
							success: function(layero) {
								layer.setTop(layero); //重点2
							}
