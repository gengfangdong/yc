	...
	<body>
		...
		<script type="text/javascript">
			...
			layui.use('table', function(){
			  ...
			  table.render({
			    elem: '#LAY_table_user',
			    url: '<%=request.getContextPath()%>/Ssuser/Laybm/<%=scheduled_id%>',
			    cols: [[
				  {type:'numbers',title:"序号",minWidth:90},
			      {field:'ssu_creater', title: '报名人',minWidth:120},
			      {field:'ssu_department', title: '单位',minWidth:180},
			      {field:'ssu_usernumber', title: '报名人数',minWidth:120},
			      {field:'ssu_username', title: '联系人',minWidth:120},
			      {field:'ssu_ydphone', title: '联系电话',minWidth:120},
			      {field:'ssu_phone', title: '办公电话',minWidth:120},
			      {field:'ssu_createtime', title: '报名时间',minWidth:180},
			      {field:'ssu_status', title: '是否上传名单',minWidth:180,templet:'#typeuserstatus'}
			    ]],
			    height:'full-110',
			    id: 'testReload',
			    page: true
