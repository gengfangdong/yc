							...
							<ul class="treeview-menu treeUl">
								<li>
									...
									<ul class="treeview-menu menu_tree">
										...
										<li>
											<a href="projectOverview.html"><i class="fa fa-square-o"></i> 项目概况</a>
										</li>
										<li>
											<a href="aboutUs.html"><i class="fa fa-square-o"></i> 关于我们</a>
										</li>
								...
								<li>
									...
									<ul class="treeview-menu menu_tree">
										...
										<li>
											<a href="classesPlan.html"><i class="fa fa-square-o"></i> 课程方案</a>
										</li>
										<li>
											<a href="prescribedShift.html"><i class="fa fa-square-o"></i> 自主报名</a>
										</li>
										<li>
								...
								<li>
									...
									<ul class="treeview-menu menu_tree">
										<li>
											<a href="projectList.html"><i class="fa fa-square-o"></i> 项目列表</a>
										</li>
										<li>
											<a href="entryList.html"><i class="fa fa-square-o"></i> 报名列表</a>
										</li>
									</ul>
								</li>
							</ul>
