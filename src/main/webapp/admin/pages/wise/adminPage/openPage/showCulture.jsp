						...
						<div class="col-sm-12 col-md-12">
							<div class="table-responsive table-responsive_vis" id="sample-table-1" style="padding-left: 10px;padding-right: 10px;">
									...
									<tbody>
										<tr>
											...
											<td class="rightTd" colspan="2">
												<input type="text" id="cultureTitle"readonly="readonly" style=" border: none; border: 1px solid #ccc; border-radius: 5px; width: 100%;height:23px;"/>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="rightTd" colspan="2">
												<input type="text" placeholder="请输入50字以下文字" id="cultureAbstract" readonly="readonly" style=" border: none; border: 1px solid #ccc; border-radius: 5px; width: 100%;height:23px;"/>
											</td>
										</tr>
										<tr>
											<td class="leftTd">关键字:</td>
											<td class="rightTd" colspan="2">
												<input type="text" placeholder="请输入5个以内关键字，用逗号隔开" id="cultureKeyWords" readonly="readonly" style=" border: none; border: 1px solid #ccc; border-radius: 5px; width: 100%;height:23px;"/>
											</td>
										</tr>
										<!--<tr>
										...
										<tr>
											...
											<td class="rightTd" colspan="2">
												<input id="cultureDate" name="cultureDate" placeholder="YYYY-MM-DD" type="text" style=" border: none; border: 1px solid #ccc; border-radius: 5px; width: 257px;height:23px;" readonly="readonly"/>
											</td>
										</tr>
										<tr>
								...
								<div style="text-align: center;">
									<button class="cultureSave saveBtn" id="cultureSave" onclick="parent.layer.close(parent.layer.getFrameIndex(window.name))">关闭</button>
								</div>
							</div>
						</div>
					</div>
