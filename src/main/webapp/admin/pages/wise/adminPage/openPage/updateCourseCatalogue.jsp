...
%>
	...
	<body>
		...
		<script>
			function courseCatalogueSave(){
				var first_course = document.getElementById("firstLevel").value;
				var second_course = document.getElementById("secondLevel").value;
				var third_course = document.getElementById("thirdLevel").value;
				var course_context = CKEDITOR.instances.newsDescription.getData();
				$.ajax({
					url:'<%=request.getContextPath()%>/Course/updateCourse',
					type:'POST',
					data:{
						"Course_id":'<%=course_id%>',
