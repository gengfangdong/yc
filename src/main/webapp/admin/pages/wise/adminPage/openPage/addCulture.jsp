	...
	<body>
		...
		layui.use('upload', function(){
			  ...
			  var uploadInst = upload.render({
			    elem: '#test1' ,
			    url: '<%=request.getContextPath()%>/Culture/saveCultureandFile',
			    auto:false,
...
// 			    	 layer.alert("保存成功!");
		...
		<script>
			function cultureSave(){
				/* var cultureCategoryLen = document.getElementById('cultureCategory').value.length;
				if(cultureCategoryLen>10){
	           ...
	           /*  if (culture_context.length == 0)
	            {
	                alert("空白");
	            }
	            else
	            {
	                alert(culture_context); 
	            }
	            alert(cultureTitle+"\n"+cultureAbstract+"\n"+cultureKeyWords+"\n"+cultureDate+"\n"+culture_status+"\n"+culture_context); */
