						...
						<div class="col-sm-12 col-md-12">
							<div class="table-responsive table-responsive_vis" id="sample-table-1" style="padding-left: 10px;padding-right: 10px;">
									...
									<tbody>
										<tr>
											...
											<td class="rightTd" colspan="2">
												<input type="text" id="taxTitle"readonly="readonly"/>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="rightTd" colspan="2">
												<input type="text" placeholder="请输入50字以下文字" id="taxAbstract" readonly="readonly"/>
											</td>
										</tr>
										<tr>
											<td class="leftTd">关键字:</td>
											<td class="rightTd" colspan="2">
												<input type="text" placeholder="请输入5个以内关键字，用逗号隔开" id="taxKeyWords" readonly="readonly"/>
											</td>
										</tr>
										<!--<tr>
										...
										<tr>
											...
											<td class="rightTd" colspan="2">
												<input id="taxDate" name="taxDate" placeholder="YYYY-MM-DD" type="text" class="" style="height: 23px;" readonly="readonly"/>
											</td>
										</tr>
										<tr>
								...
								<div style="text-align: center;">
									<button class="taxSave saveBtn" id="taxSave" onclick="">关闭</button>
								</div>
							</div>
						</div>
					</div>
