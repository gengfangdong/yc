	...
	<body>
				...
				<div class="col-sm-12 col-md-12 layui-tab layui-tab-card">
			    	<div class="row">
						<div class="col-sm-12 col-md-12">
							...
							<input type="projectid" name="projectid" id="projectid" hidden="hidden">
								...
								<div style="text-align: center;">
									<button class="newsSave saveBtn"  onclick="save();">保存</button>
								</div>
							</div>
						</div>
					</div>
		...
		<script>
			function save(){
				...
				var projectlistDate = document.getElementById("addProjectListDate").value;

				$.ajax({
					url : '<%=request.getContextPath()%>/Project/updateProject',
					type : 'post',
					dataType:"json",
					data:{
						Project_id:projectid,
						Project_name:projectname,
						Project_date:projectlistDate,
			 ...
			 window.onload = function(){
				...
				success : function(data) {
					if(data.success == true){
						...
						projectid.value=project_id; //id
						projectname.value = project_name;//名称
