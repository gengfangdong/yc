							...
							<ul class="treeview-menu treeUl">
								<li>
									...
									<ul class="treeview-menu menu_tree">
										...
										<!-- <li>
											<a href="aboutUs.jsp"  style="color: #ffffff;"><i class="fa fa-square-o"></i> 关于我们</a>
										</li> -->
																				...
																				<table id="branchPage" class="table table-bordered table-hover example1_x" style="margin-top: 20px!important;">
																					<thead>
																						<tr>
																							...
																							<th style="text-align:center;">关于我们id</th>
		...
		<script>
			$(function() {
				...
				var branchPage = $('#branchPage').DataTable({
					...
					"autoWidth": false,
					ajax: {
		                url: "<%=request.getContextPath()%>/About/getlist"
		            },
		            serverSide: true,
		            columns: [
		            ...
		            "aoColumnDefs":[{"targets":1,
		            	visible:false
	                        ...
	                        render: function(data, type, row) {
	                            var html ='<a id=\"show\" href=\"#\" onclick=\"addBranch(this,\''+row.about_id+'\');\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\" onclick=\"addBranch(this,\''+row.about_id+'\');\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;';
	                            return html;
	                        }
	                    }],
