	...
	<body class="hold-transition skin-blue sidebar-mini">
							...
							<ul class="treeview-menu treeUl">
								...
								<li>
									...
									<ul class="treeview-menu menu_tree">
										...
										<li>
											<a href="expertTeam.jsp" style="color: #ffffff;"><i class="fa fa-square-o"></i> 专家团队</a>
										</li>
														...
														<div class="tab-pane fade in active" id="taxpayerAnalysis" style="margin-top: 5px;">
															<div class="form-group" style="width: 100%;margin-top: 5px;height: 32px;line-height: 32px;margin-bottom: 0;">
																<div class="col-sm-10" style="height: 32px;line-height: 32px;">
																	<ul class="f-sort-ul">
																		<li><button class="add" onclick="addExpert(this);">新增</button></li>
																	</ul>
																</div>
															</div>
															...
															<div class="row">
																<div class="col-sm-12 col-md-12">
																	<div class="table-responsive table-responsive_vis" id="sample-table-1" style="padding-left: 10px;padding-right: 10px;">
																		<table id="expertPage" class="table table-bordered table-hover example1_x" style="margin-top: 20px!important;">
																			<thead>
																				<tr>
																			...
																			<!-- <tbody>
																				<tr>
																					...
																					<td>待发布</td>
																					<td>
																						<a href="#" onclick="addExpert(this);">查看</a>
																						<a href="#" onclick="addExpert(this);">修改</a>
		...
		<script>
			$(function() {
				...
				var expertPage = $('#expertPage').DataTable({
					...
					"autoWidth": false,
					ajax: {
						url: "<%=request.getContextPath()%>/Expert/getlist"
					},
					serverSide: true,
					columns: [
					...
					"aoColumnDefs": [{
						...
						/* //设置列的属性，此处设置第一列不排序
								                      {"targets":5,
								                         "data": null,
								                        "bSortable": false,
								                        "defaultContent": "<p>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"show\" href=\"#\" onclick=\"addExpert(this);\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"del\"  href=\"#\">删除</a></p>"
								              }, */
						{ //倒数第一列
							"targets": -1,
							"bSortable": false,
							render: function(data, type, row) {
								var html = '<a id=\"show\" href=\"#\" onclick=\"addExpert(this,\'' + row.expert_id + '\');\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\" onclick=\"addExpert(this,\'' + row.expert_id + '\');\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"del\"  href=\"#\" onclick=\"addExpert(this,\'' + row.expert_id + '\');\">删除</a></p>';
								return html;
							}
						}
					],
		...
		<script type="text/javascript">
			...
			$('#expertPage tbody').on('click', 'a#edit', function() {
				var data = $('#expertPage').DataTable().row($(this).parents('tr')).data();
				alert("查看修改：" + data.tenantName + "," + data.id);
			});

			function addExpert(obj, id) {
				...
				if(sText == '新增') {
					layui.use('layer', function() {
						...
						layer.open({
							...
							maxmin: true,
							offset: [100, 200],
							content: 'openPage/addExpert.jsp',
					...
					layui.use('layer', function() {
						...
						layer.open({
							...
							maxmin: true,
							offset: [100, 200],
							content: 'openPage/showExpert.jsp?expert_id=' + id,
							zIndex: layer.zIndex, //重点1
							success: function(layero) {
								layer.setTop(layero); //重点2
							}
					...
					layui.use('layer', function() {
						...
						layer.open({
							...
							maxmin: true,
							offset: [100, 200],
							content: 'openPage/updateExpert.jsp?expert_id=' + id,
							zIndex: layer.zIndex, //重点1
							success: function(layero) {
								layer.setTop(layero); //重点2
							}
					...
					$.ajax({
						url: '<%=request.getContextPath()%>/Expert/deleteExpert',
						type: 'post',
						dataType: "json",
						data: {
							Expert_id: id
