																				...
																				<table id="branchPage" class="table table-bordered table-hover example1_x" style="margin-top: 20px!important;">
																					<thead>
																						<tr>
																							...
																							<th style="text-align:center;">项目概况id</th>
		...
		<script>
			$(function() {
				...
				var branchPage = $('#branchPage').DataTable({
					...
					"autoWidth": false,
					ajax: {
		                url: "<%=request.getContextPath()%>/ProjectView/getlist"
		            },
		            serverSide: true,
		            columns: [
		            ...
		            "aoColumnDefs":[{"targets":1,
		            	visible:false
	                        ...
	                        render: function(data, type, row) {
	                            var html ='<a id=\"show\" href=\"#\" onclick=\"addBranch(this,\''+row.projectView_id+'\');\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\" onclick=\"addBranch(this,\''+row.projectView_id+'\');\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;</p>';
	                            return html;
	                        }
	                    }], 
				...
				if(sText=='新增'){
					layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/addProjectOverview.jsp',
					...
					layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/showProjectOverview.jsp?projectView_id='+id,
					        zIndex: layer.zIndex, //重点1
					        success: function(layero){
					          layer.setTop(layero); //重点2
					        }
					...
					layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/updateProjectOverview.jsp?projectView_id='+id,
					        zIndex: layer.zIndex, //重点1
					        success: function(layero){
					          layer.setTop(layero); //重点2
					        }
