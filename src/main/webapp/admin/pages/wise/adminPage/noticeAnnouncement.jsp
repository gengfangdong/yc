							...
							<ul class="treeview-menu treeUl">
								<li>
									...
									<ul class="treeview-menu menu_tree">
										<li>
											<a href="noticeAnnouncement.jsp" style="color: #ffffff;"><i class="fa fa-square-o"></i> 通知公告</a>
										</li>
										<li>
		...
		<script>
			$(function() {
				...
				var newsPage = $('#newsPage').DataTable({
					...
					"autoWidth": false,
					ajax: {
		                url: "<%=request.getContextPath()%>/Notice/getlist"
		            },
		            serverSide: true,
		            columns: [
		            ...
		            "aoColumnDefs":[{"targets":1,
		            	visible:false
	                        ...
	                        render: function(data, type, row) {
	                            var html ='<a id=\"show\" href=\"#\" onclick=\"addNews(this,\''+row.notice_id+'\');\">查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"edit\" href=\"#\" onclick=\"addNews(this,\''+row.notice_id+'\');\">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id=\"del\"  href=\"#\" onclick=\"addNews(this,\''+row.notice_id+'\');\">删除</a></p>';
	                            return html;
	                        }
	                    }], 
		        ...
		        if(sText=='新增'){
		        	layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/addNoticeAnnouncement.jsp',
		        	...
		        	layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/showNoticeAnnouncement.jsp?notice_id='+id,
					        zIndex: layer.zIndex, //重点1
					        success: function(layero){
					          layer.setTop(layero); //重点2
					        }
		        	...
		        	layui.use('layer',function(){
			        	...
			        	layer.open({
					        ...
					        maxmin: true,
					        offset: [100,200] ,
					        content: 'openPage/updateNoticeAnnouncement.jsp?notice_id='+id,
					        zIndex: layer.zIndex, //重点1
					        success: function(layero){
					          layer.setTop(layero); //重点2
					        }
