		...
		<div class="inp">
			...
			<div>
				<form method="post">
					...
					-->
					<div class="login">
						<input type="button" value="登          录" onclick="login();" onmouseover="this.style.backgroundColor='#FFFFFF';this.style.color='#050a2a'" onmouseout="this.style.backgroundColor='#050a2a';this.style.color='#FFFFFF'"/>
					</div>
				</form>
			</div>
		</div>
				...
				success : function(data) {
					if(data.success == true){
						if(data.msg == "1"){
							 ...
							 javascript:location.href='<%=request.getContextPath()%>/admin/pages/wise/memberPage/memberMessage';
						}else if(data.msg == "2"){
							javascript:location.href='<%=request.getContextPath()%>/admin/pages/wise/adminPage/noticeAnnouncement';
						}
