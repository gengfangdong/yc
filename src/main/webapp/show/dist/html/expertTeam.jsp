...
<div class="layout">
                                            ...
                                            <ul class="am-nav am-nav-pills am-nav-justify">
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="menu-item">
                                                            <a href="expertTeam.jsp" style="color: #FF2F2F;">专家团队</a>
                                                        </li>
                                                    </ul>
                                                    <!-- sub-menu end-->
                                                </li>
										...
										<ul class="am-menu-nav am-avg-sm-1">
											...
											<li class="am-parent">
												...
												<ul class="am-menu-sub am-collapse ">
													...
													<li class="">
														<a href="expertTeam.jsp" class="" style="color: #FF2F2F;">专家团队</a>
													</li>
												</ul>
											</li>
											<li class="">
    ...
    <div class="am-g am-g-fixed myFixedSiderbar">
        ...
        <div class="am-u-md-9 am-u-md-push-3  mainBody" style="padding-right: 100px;">
            <div class="breadcrumb-box">
                <div class="am-container">
                    <ol class="am-breadcrumb">
                        ...
                        <li class="am-active">专家团队</li>
                    </ol>
                </div>
            </div>
            <div class="am-cf am-article tableTextAlign">
				<table id="expertTable"  class="am-table am-table-bordered am-table-radius am-table-compact am-table-centered littleFontSize">
					<thead>
					<tr>
						<th>序号</th>
						<th>标题</th>
            ...
            <div class="expertTeamList">
						<ul>
							<!-- <li>
								<span class="expertTeamDate">2018-11-29</span> ●&nbsp;&nbsp;
								<a href="expertTeam_content.jsp">专家团队介绍一</a>
							</li>
							<li>
								<span class="expertTeamDate">2018-11-28</span> ●&nbsp;&nbsp;
								<a href="expertTeam_content.jsp">专家团队介绍二</a>
							</li>
							<li>
								<span class="expertTeamDate">2018-11-27</span> ●&nbsp;&nbsp;
								<a href="expertTeam_content.jsp">专家团队介绍三</a>
							</li>
							<li>
								<span class="expertTeamDate">2018-11-26</span> ●&nbsp;&nbsp;
								<a href="expertTeam_content.jsp">专家团队介绍四</a>
							</li>
							<li>
								<span class="expertTeamDate">2018-11-25</span> ●&nbsp;&nbsp;
								<a href="expertTeam_content.jsp">专家团队介绍五</a>
							</li> -->
						</ul>
                ...
                <div class="am-offcanvas-bar">
                    <ul class="am-nav">
                        ...
                        <li class="promo_detailed--list_item sidebarListLi"
                            ...
                            <a href="expertTeam.jsp" style="font-weight: 600;color: #FF2F2F;">专家团队</a>
                        </li>
                    </ul>
                    <ul class="am-nav">
...
<script type="text/javascript">
			...
			function showcontext(id) {
			    window.location.href='expertTeam_content.jsp?expert_id='+id;
			}
			...
			var expertTable = $('#expertTable').DataTable({
			...
			"autoWidth": false,
			ajax: {
			url: "<%=request.getContextPath()%>/Show/getlistExpert"
			},
			serverSide: true,
			columns: [
			...
			"aoColumnDefs":[
			    	{
					    ...
					    render: function(data, type, row) {
					        var html ='<a id=\"show\"   title=\"点击查看详情\"    href=\"javascript:showcontext(\''+row.expert_id+'\')\">'+row.expert_titile+'</a>';
					        return html;
					    }},
			 			{		
			"targets":-1,
