...
<html lang="en">
		...
		<div class="layout">
													...
													<ul class="am-nav am-nav-pills am-nav-justify">
														...
														<li>
															...
															<ul class="sub-menu">
																...
																<li class="menu-item">
																	<a href="teachingMaterialSystem.jsp" style="color: #FF2F2F;">教材体系</a>
																</li>
																<li class="menu-item">
										...
										<ul class="am-menu-nav am-avg-sm-1">
											...
											<li class="am-parent">
												...
												<ul class="am-menu-sub am-collapse ">
													...
													<li class="">
														<a href="teachingMaterialSystem.jsp" class="" style="color: #FF2F2F;">教材体系</a>
													</li>
													<li class="">
			...
			<div class="layout-container">
				<div class="page-header news_bannerBg">
					<div class="am-container">
						<h1 class="page-header-title">教材体系</h1>
					</div>
				</div>
			...
			<div class="am-g am-g-fixed myFixedSiderbar">
				...
				<div class="am-u-md-9 am-u-md-push-3 mainBody" style="padding-right: 100px;">
					<div class="breadcrumb-box">
						<div class="am-container">
							<ol class="am-breadcrumb">
								...
								<li class="am-active">教材体系</li>
							</ol>
						</div>
					</div>
					<div class="am-cf am-article tableTextAlign">
						<table id="teachingTable"  class="am-table am-table-bordered am-table-radius am-table-compact am-table-centered littleFontSize">
							<thead>
							<tr>
								<th>序号</th>
								<th>标题</th>
					...
					<div class="teachingMaterialSystemList">
						<ul>
							<!-- <li>
								<span class="teachingMaterialSystemDate">2018-11-29</span> ●&nbsp;&nbsp;
								<a href="teachingMaterialSystem_content.jsp">培养体系介绍一</a>
							</li>
							<li>
								<span class="teachingMaterialSystemDate">2018-11-28</span> ●&nbsp;&nbsp;
								<a href="teachingMaterialSystem_content.jsp">培养体系介绍二</a>
							</li>
							<li>
								<span class="teachingMaterialSystemDate">2018-11-27</span> ●&nbsp;&nbsp;
								<a href="teachingMaterialSystem_content.jsp">培养体系介绍三</a>
							</li>
							<li>
								<span class="teachingMaterialSystemDate">2018-11-26</span> ●&nbsp;&nbsp;
								<a href="teachingMaterialSystem_content.jsp">培养体系介绍四</a>
							</li>
							<li>
								<span class="teachingMaterialSystemDate">2018-11-25</span> ●&nbsp;&nbsp;
								<a href="teachingMaterialSystem_content.jsp">培养体系介绍五</a>
							</li> -->
						</ul>
					...
					<div class="am-offcanvas" id="sidebar">
						<div class="am-offcanvas-bar">
							<ul class="am-nav">
								...
								<li class="promo_detailed--list_item sidebarListLi" style="text-align: center;padding: 5px 0 0px 0;">
									<a href="teachingMaterialSystem.jsp" style="font-weight: 600;color: #FF2F2F;">教材体系</a>
								</li>
    ...
    <![endif]-->
		...
		function showcontext(id) {
            window.location.href='teachingMaterialSystem_content.jsp?teaching_id='+id;
			}
			...
			var teachingTable = $('#teachingTable').DataTable({
			...
			"autoWidth": false,
			ajax: {
			    url: "<%=request.getContextPath()%>/Show/getlistTeaching"
			},
			serverSide: true,
			columns: [
			    ...
			    {"data": "teaching_titile"},
			    {"data": "teaching_Release_time"}
			],
			"aoColumnDefs":[
			            	{
							    "targets":-2,
							    ...
							    render: function(data, type, row) {
							        var html ='<a id=\"show\"   title=\"点击查看详情\"    href=\"javascript:showcontext(\''+row.teaching_id+'\')\">'+row.teaching_titile+'</a>';
							        return html;
							    }},
					 			{		
			        "targets":-1,
			...
			window.onload = function() {
				var oteachingMaterialSystemList = document.getElementsByClassName('teachingMaterialSystemList')[0];
				if(oteachingMaterialSystemList.children[0].childElementCount) {
					var teachingMaterialSystemListNum = oteachingMaterialSystemList.children[0].childElementCount;
					var teachingMaterialSystemListNumHeight = teachingMaterialSystemListNum * 35 + 5 + 'px';
					$('.teachingMaterialSystemList').css('height', teachingMaterialSystemListNumHeight);
				}
			}
		</script>
	</body>
