...
<html lang="en">
	...
	<body>
		<div class="layout">
                                            ...
                                            <ul class="am-nav am-nav-pills am-nav-justify">
                                                ...
                                                <li style="min-width:90px;">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="menu-item">
                                                            <a href="teachingMaterialSystem.jsp" style="color: #FF2F2F;">往期回顾</a>
                                                        </li>
                                                        <!-- <li class="menu-item">
										...
										<ul class="am-menu-nav am-avg-sm-1">
											...
											<li class="am-parent">
												...
												<ul class="am-menu-sub am-collapse ">
													...
													<li class="">
														<a href="teachingMaterialSystem.jsp" class="" style="color: #FF2F2F;">往期回顾</a>
													</li>
													<!-- <li class="">
			...
			<div class="layout-container">
				<div class="page-header news_bannerBg" style="background:url('../assets/img/banner/wangqihuigu.jpg');background-size:100% 100%;">
				</div>
					...
					<div class="am-offcanvas" id="sidebar">
						<div class="am-offcanvas-bar">
							<ul class="am-nav">
								...
								<li class="promo_detailed--list_item sidebarListLi" style="text-align: center;padding: 5px 0 0px 0;">
									<a href="teachingMaterialSystem.jsp" style="font-weight: 600;color: #FF2F2F;">往期回顾</a>
								</li>
    ...
    <![endif]-->
		...
		$(document).ready(function() {
				  $.ajax({
						url : '<%=request.getContextPath()%>/Show/findAllTeaching',
						type : 'post',
						async:false,
			      		dataType:'json',
						success : function(data) {
							...
							for(var i=0;i <datas.length;i++){ 
								zz[i]= '<span class="teachingMaterialSystemDate">'+datas[i].teaching_Release_time.slice(0,10)+'</span> ●&nbsp;&nbsp;<a href=\"teachingMaterialSystem_content.jsp?teaching_id='+datas[i].teaching_id+'\" target="_blank">'+datas[i].teaching_titile+'</a>'
						    } //div的字符串数组付给zz
							var pageno=1 ;              //当前页
