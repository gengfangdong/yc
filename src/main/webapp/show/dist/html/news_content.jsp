            	...
            	if(data.success == true){
            		var news_context = data.data.news_context;
 					 document.getElementById('showNewsContent').innerHTML=
 						...
 						'<label style="padding-right: 3%;">作者：'+data.data.news_Creater+'</label>'+
 						'<label style="padding-left: 3%;">时间：'+data.data.news_Release_time.slice(0,10)+'</label></div><div>'+news_context;
            	}
            },
