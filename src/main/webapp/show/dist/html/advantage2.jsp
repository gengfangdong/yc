                ...
                <div class="am-u-sm-11 am-u-sm-centered">
                    <div class="am-cf am-article"   id="solutioncontext">
                        <div style="text-align: center;">
                            <h1 class="am-article-title" style="margin:0;">以人才培养为目标</h1>
                            <h4 class="am-article-title" style="margin-top:0.6rem;font-size:2rem;font-weight:400;">健全多层次一站式培养体系</h4>
                        </div>

                        <p style="text-indent: 25px;">
                           	针对大多税务培训机构关注干部技能培训较多，关注干部成长不足的特点，“领税”培训项目建立了涵盖基础班、骨干班、项目班、研究生课程进修班等层次的培养体系，为各级、各岗位税务在职干部搭建一个职业生涯成长成才的平台。
                        </p>
