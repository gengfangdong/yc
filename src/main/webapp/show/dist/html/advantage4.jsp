                ...
                <div class="am-u-sm-11 am-u-sm-centered">
                    <div class="am-cf am-article"   id="solutioncontext">
                        <div style="text-align: center;">
                            <h1 class="am-article-title" style="margin:0;">以科技创新为依托</h1>
                            <h4 class="am-article-title" style="margin-top:0.6rem;font-size:2rem;font-weight:400;">破解税务培训工作难点痛点</h4>
                        </div>

                        <p style="text-indent: 25px;">
                           	结合几年承办税务系统培训所遇到的难点、痛点问题，我校树立互联网思维，研发并即将推出智能化“领税”平台，结合各种培训场景，平台将培训师资、参训单位、培训场地等要素进行智能连接，并做到智能运维、智能考评，将极大改进培训效果，提升培训质量。
                        </p>
