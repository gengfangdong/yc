...
<div class="layout">
                                            ...
                                            <ul class="am-nav am-nav-pills am-nav-justify">
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="menu-item">
                                                            <a href="taxCollectionFund.jsp" style="color: #FF2F2F;">领税基金</a>
                                                        </li>
                                                        <li class="menu-item">
										...
										<ul class="am-menu-nav am-avg-sm-1">
											...
											<li class="am-parent">
												...
												<ul class="am-menu-sub am-collapse ">
													...
													<li class="">
														<a href="taxCollectionFund.jsp" class="" style="color: #FF2F2F;">领税基金</a>
													</li>
													<li class="">
    ...
    <div class="layout-container">
        <div class="page-header news_bannerBg">
            <div class="am-container">
                <h1 class="page-header-title">领税基金</h1>
            </div>
        </div>
    ...
    <div class="am-g am-g-fixed myFixedSiderbar">
        ...
        <div class="am-u-md-9 am-u-md-push-3 mainBody" style="padding-right: 100px;">
            <div class="breadcrumb-box">
                <div class="am-container">
                    <ol class="am-breadcrumb">
                        ...
                        <li class="am-active">领税基金</li>
                    </ol>
                </div>
            </div>
            <div class="am-cf am-article tableTextAlign">
				<table id="taxTable"  class="am-table am-table-bordered am-table-radius am-table-compact am-table-centered littleFontSize">
					<thead>
					<tr>
						<th>序号</th>
						<th>标题</th>
            ...
            <div class="taxCollectionFundList">
						<ul>
						<!-- 	<li>
								<span class="taxCollectionFundDate">2018-11-29</span> ●&nbsp;&nbsp;
								<a href="taxCollectionFund_content.jsp">培养体系介绍一</a>
							</li>
							<li>
								<span class="taxCollectionFundDate">2018-11-28</span> ●&nbsp;&nbsp;
								<a href="taxCollectionFund_content.jsp">培养体系介绍二</a>
							</li>
							<li>
								<span class="taxCollectionFundDate">2018-11-27</span> ●&nbsp;&nbsp;
								<a href="taxCollectionFund_content.jsp">培养体系介绍三</a>
							</li>
							<li>
								<span class="taxCollectionFundDate">2018-11-26</span> ●&nbsp;&nbsp;
								<a href="taxCollectionFund_content.jsp">培养体系介绍四</a>
							</li>
							<li>
								<span class="taxCollectionFundDate">2018-11-25</span> ●&nbsp;&nbsp;
								<a href="taxCollectionFund_content.jsp">培养体系介绍五</a>
							</li> -->
						</ul>
            ...
            <div class="am-offcanvas" id="sidebar">
                <div class="am-offcanvas-bar">
                    <ul class="am-nav">
                        ...
                        <li class="promo_detailed--list_item sidebarListLi"
                            style="text-align: center;padding: 5px 0 0px 0;">
                            <a href="taxCollectionFund.jsp" style="font-weight: 600;color: #FF2F2F;">领税基金</a>
                        </li>
...
<script type="text/javascript">
		...
		function showcontext(id) {
		    window.location.href='taxCollectionFund_content.jsp?tax_id='+id;
		}
		...
		"autoWidth": false,
		ajax: {
		url: "<%=request.getContextPath()%>/Show/getlistTax"
		},
		serverSide: true,
		columns: [
		...
		"aoColumnDefs":[
		    	{
				    ...
				    render: function(data, type, row) {
				        var html ='<a id=\"show\"   title=\"点击查看详情\"    href=\"javascript:showcontext(\''+row.tax_id+'\')\">'+row.tax_titile+'</a>';
				        return html;
				    }},
		 			{		
		"targets":-1,
		...
		"stripeClasses": ["datatable_odd","datatable_even"]	
			...
			window.onload = function() {
				var otaxCollectionFundList = document.getElementsByClassName('taxCollectionFundList')[0];
				if(otaxCollectionFundList.children[0].childElementCount) {
					var taxCollectionFundListNum = otaxCollectionFundList.children[0].childElementCount;
					var taxCollectionFundListNumHeight = taxCollectionFundListNum * 35 + 5 + 'px';
					$('.taxCollectionFundList').css('height', taxCollectionFundListNumHeight);
				}
			}
		</script>
</body>
