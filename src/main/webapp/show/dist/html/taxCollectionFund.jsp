...
<div class="layout">
    ...
    <div class="layout-container">
        <div class="page-header news_bannerBg" style="background:url('../assets/img/banner/taxSystem.jpg');background-size:100% 100%;">
        </div>
...
// 			window.onload = function() {
		$(document).ready(function() {
				  $.ajax({
						url : '<%=request.getContextPath()%>/Show/findAllTax',
						type : 'post',
						async:false,
			      		dataType:'json',
...
// 							if(data.success == true){
							...
							for(var i=0;i <datas.length;i++){ 
								zz[i]= '<span class="taxCollectionFundDate">'+datas[i].tax_Release_time+'</span> ●&nbsp;&nbsp;<a href=\"taxCollectionFund_content.jsp?tax_id='+datas[i].tax_id+'\" target="_blank">'+datas[i].tax_titile+'</a>'
						    } //div的字符串数组付给zz
							var pageno=1 ;              //当前页
