...
<div class="layout">
    ...
    <div class="am-g am-g-fixed myFixedSiderbar">
        ...
        <div class="am-u-md-9 am-u-md-push-3 mainBody" style="padding-right: 5%;">
            ...
            <div class="am-g">
                <div class="am-u-sm-11 am-u-sm-centered"  id="taxcontext">
                    <div class="am-cf am-article">
                        <div style="text-align: center;">
                            <h1 class="am-article-title">领税基金</h1>
...
//         		CKEDITOR.replace('teachingDescription');
        		$.ajax({
				url : '<%=request.getContextPath()%>/Show/getTaxdetailByid',
				type : 'GET',
				data:{
					tax_id:'<%=tax_id%>'
				},
				success : function(data) {
					if(data.success == true){
						var tax_context = data.data.tax_context;
						 document.getElementById('taxcontext').innerHTML=
							 '<div style="text-align: center;">'+'<h1 class="am-article-title">'+data.data.tax_titile+'</h1>'+
		 						'<p class="am-article-meta" style="border-bottom: 1px solid #999999;border-top: 1px solid #999999;">'+
		 						'<label style="padding-right: 3%;">作者：'+data.data.tax_Creater+'</label>'+
		 						'<label style="padding-left: 3%;">时间：'+data.data.tax_Release_time+'</label>'+tax_context;
					}
				},
