										...
										<div class="am-u-sm-11 am-u-sm-centered">
											<div class="screeningConditions">
												<div class="conditionYear">
													<ul class="conditionYearUl">
														<li class="conditionYearLi">累计天数：</li>
														<li class="">
															共<span class="classesDate">2</span>天
														</li>
														<!--<li style="float: right;">
															<button type="button" class="am-btn am-btn-primary am-round subBtn">
																<a href="" style="color: #FFFFFF;">提交</a>
															</button>
														</li>-->
													</ul>
												</div>
												<div class="conditionProject">
													<ul class="conditionProjectUl">
														<li class="conditionProjectLi">选择目录：</li>
														<li>
															<a onclick="changeStyleColor3(this);">全部</a>
														</li>
														<li>
															<a onclick="changeStyleColor3(this);">类别1</a>
														</li>
														<li>
															<a onclick="changeStyleColor3(this);">类别2</a>
														</li>
														<li>
															<a onclick="changeStyleColor3(this);">类别3</a>
														</li>
														<li>
															<a onclick="changeStyleColor3(this);">类别4</a>
														</li>
													</ul>
												</div>
											</div>
											<div class="am-cf am-article tableTextAlign">
												<table class="am-table am-table-bordered am-table-radius am-table-compact am-table-centered littleFontSize">
													...
													<tr>
														<td>
															<input type="radio" name="classesName2" onclick="sumClassesTime(this);" />
														</td>
														<td data-am-modal="{target: '#my-popup'}">
															<a title="点击查看详情">基础学习</a>
														</td>
														<td>
															<select>
														...
														<td>
															<button type="button" class="am-btn am-btn-primary am-round" style="height: 23px;font-size: 14px;line-height: 8px;"><a href="#" style="color: #ffffff;">定制</a></button>
														</td>
													</tr>
													<tr>
														<td>
											...
											<div class="am-cf am-article tableTextAlign">
												<table class="am-table am-table-bordered am-table-radius am-table-compact am-table-centered littleFontSize">
													...
													<tbody>
														<tr>
															<td>
																<input type="checkbox" name="classesName" onclick="sumClassesTime(this);" />
															</td>
															<td data-am-modal="{target: '#my-popup'}">
																<a title="点击查看详情">基础学习</a>
															</td>
															<td data-am-modal="{target: '#my-popup'}">
																<a title="点击查看详情">税法一</a>
															</td>
															<td>16</td>
														</tr>
														<tr>
										...
										<div class="am-u-sm-11 am-u-sm-centered">
											<div class="am-cf am-article tableTextAlign">
												<table class="am-table am-table-bordered am-table-radius onlineTable littleFontSize">
													<tbody>
														<tr>
															<td class="tableLeftTd3">课程名称</td>
															<td class="tableRightTd3">
																<input class="onlineInput" type="text" placeholder="请填写您的希望学习的课程" />
															</td>
														</tr>
														<tr>
															<td class="tableLeftTd3">天数</td>
															<td class="tableRightTd3">
																<input class="onlineInput" type="text" placeholder="请填写您的可学习的天数" />
															</td>
														</tr>
														<tr>
															<td class="tableLeftTd3">地点</td>
															<td class="tableRightTd3">
																<input class="onlineInput" type="text" placeholder="请输入适合您的学习地点" />
															</td>
														</tr>
														<tr>
															<td class="tableLeftTd3">时间</td>
															<td class="tableRightTd3">
																<input class="onlineInput" type="text" placeholder="请填写您的真实姓名" />
															</td>
														</tr>
														<tr>
															<td class="tableLeftTd3">参与人数</td>
															<td class="tableRightTd3">
																<input class="onlineInput" type="text" placeholder="请输入您的真实姓名" />
															</td>
														</tr>
														<tr>
															<td class="tableLeftTd3">其他信息</td>
															<td class="tableRightTd3">
																<textarea placeholder="请输入您的学习方向、学习时间等信息" style="width: 100%;height: 150px;"></textarea>
