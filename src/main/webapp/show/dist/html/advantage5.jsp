...
<div class="layout">
    ...
    <div class="layout-container">
        <div class="page-header news_bannerBg" style="background:url('../assets/img/banner/xiangmugaikuang.jpg');background-size:100% 100%;">
        </div>
                ...
                <div class="am-u-sm-11 am-u-sm-centered">
                    <div class="am-cf am-article"   id="solutioncontext">
                        <div style="text-align: center;">
                            <h1 class="am-article-title" style="margin:0;">以共建共生为路径</h1>
                            <h4 class="am-article-title" style="margin-top:0.6rem;font-size:2rem;font-weight:400;">推进税收生态系统建设</h4>
                        </div>

                        <p style="text-indent: 25px;">
                           	为扩大服务范围，“领税”项目采取走出去战略，在各地逐步设立或同地方高校、税校共建 “领税”教育中心，破解因北京师资资源丰富，后勤保障资源紧张等困局；为统一培训质量，建立了中央厨房式的教研体系，北京统一负责产品开发、方案设计、师资调配、考核监督，地方负责后勤保障、教务管理，并结合地方行业特点和工作实际，融入能体现当地管理经验的特色课程；为提供整体解决方案，创立以项目集群为载体的协同创新模式，同相关高校、科研机构、科技公司深度合作，发挥各自优势，逐步推出数据集市、应用系统、创新基地等项目，共建“领税”品牌，构建以服务税收管理现代化为愿景的智能化生态系统。
                        </p>
