                ...
                <div class="am-u-sm-11 am-u-sm-centered">
                    <div class="am-cf am-article"   id="solutioncontext">
                        <div style="text-align: center;">
                            <h1 class="am-article-title" style="margin:0;">以岗位培训为入口</h1>
                            <h4 class="am-article-title" style="margin-top:0.6rem;font-size:2rem;font-weight:400;">提供细分领域整体解决方案</h4>
                        </div>

                        <p style="text-indent: 25px;">
                           	结合税务部门各业务条块特点，“领税”培训项目整合政、产、学研资源，提供各业务条块整体解决方案，如税收经济分析培训，“领税”项目为参训单位和学员提供“领税”数据库、 “领税”税收经济分析平台、“领税”创新基地等后续合作，做到培训的效果可计量、培训后的工作可支持。
                        </p>
