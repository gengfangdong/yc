											...
											<div class="nav-contain" style="border: none;box-shadow: none;">
												<div class="nav-inner">
													<ul class="am-nav am-nav-pills am-nav-justify">
														...
														<li>
															<a href="centerOverview.jsp" style="#ff2f2f;">关于我们</a>
															<!-- sub-menu start-->
															<ul class="am-menu-sub am-collapse">
																...
																<li class="menu-item">
																	<a href="organization.jsp" style="#ff2f2f;">师资招聘</a>
																</li>
																<!-- <li class="menu-item">
											...
											<li class="am-parent">
												<a href="centerOverview.jsp" style="color: #FF2F2F;">关于我们</a>
															...
															<ul class="sub-menu">
																...
																<li class="menu-item">
																	<a href="organization.jsp" style="color: #FF2F2F;">师资招聘</a>
																</li>
																<!-- <li class="menu-item">
																	<a href="aboutSchool.jsp">学校介绍</a>
																</li> -->
						...
						<div class="am-offcanvas-bar">
							<ul class="am-nav">
								...
								<li class="promo_detailed--list_item sidebarListLi" style="border-bottom: 1px solid #001A35;text-align: center;padding: 5px 0 10px 0;">
									<a href="organization.jsp" style="font-weight: 600;color: #FF2F2F;">师资招聘</a>
								</li>
							</ul>
							<ul class="am-nav">
