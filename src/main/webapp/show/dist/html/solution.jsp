...
<div class="layout">
                                            ...
                                            <ul class="am-nav am-nav-pills am-nav-justify">
                                                ...
                                                <li style="min-width:90px;">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="menu-item">
                                                            <a href="solution.jsp"  style="color: #FF2F2F;">特色项目</a>
                                                        </li>
                                                        <li class="menu-item">
								...
								<div class="am-offcanvas">
									<div class="am-offcanvas-bar">
										...
										<ul class="am-menu-nav am-avg-sm-1">
											...
											<li class="am-parent">
												<a href="centerOverview.jsp" style="color:#FF2F2F;">下载中心</a>
															<!-- sub-menu start-->
															<!-- <ul class="sub-menu">
																<li class="menu-item">
																	<a href="centerOverview.jsp">概况</a>
    ...
    <div class="layout-container">
        <div class="page-header news_bannerBg" style="background:url('../assets/img/banner/tesexiangmu.jpg');background-size:100% 100%;">
        </div>
                ...
                <div class="am-offcanvas-bar">
                    <ul class="am-nav">
                        ...
                        <li class="promo_detailed--list_item sidebarListLi"
                            ...
                            <a href="solution.jsp" style="font-weight: 600;color: #FF2F2F;">特色项目</a>
                        </li>
...
// 							if(data.success == true){
							...
							for(var i=0;i <datas.length;i++){ 
								zz[i]= '<span class="solutionDate">'+datas[i].solution_Release_time.slice(0,10)+'</span> ●&nbsp;&nbsp;<a href=\"solution_content.jsp?solution_id='+datas[i].solution_id+'\" target="_blank">'+datas[i].solution_titile+'</a>'
						    } //div的字符串数组付给zz
							var pageno=1 ;              //当前页
