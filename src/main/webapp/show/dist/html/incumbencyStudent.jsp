...
// 							if(data.success == true){
					...
					/* 			<li>
								...
								zz[i]= '<span class="incumbencyDate">'+datas[i].rules_Release_time+'</span> ●&nbsp;&nbsp;<a href="incumbencyStudentContent.jsp?rules_id='+datas[i].rules_id+'" target="_blank">'+datas[i].rules_titile+'</a>'
						    } //div的字符串数组付给zz
							var pageno=1 ;              //当前页
