...
// 							if(data.success == true){
							...
							for(var i=0;i <datas.length;i++){ 
								zz[i]= '<span class="cultureSystemDate">'+datas[i].culture_Release_time.slice(0,10)+'</span> ●&nbsp;&nbsp;<a href=\"cultureSystem_content.jsp?culture_id='+datas[i].culture_id+'\" target="_blank">'+datas[i].culture_titile+'</a>'
						    } //div的字符串数组付给zz
							var pageno=1 ;              //当前页
