        ...
        <div class="am-u-md-9 am-u-md-push-3 mainBody" style="padding-right: 5%;">
            ...
            <div class="am-g">
                <div class="am-u-sm-11 am-u-sm-centered">
                    <div class="am-cf am-article"   id="teachingcontext">
                        <div style="text-align: center;">
<!--                             <h1 class="am-article-title">教材体系</h1> -->
...
//         		CKEDITOR.replace('teachingDescription');
        		$.ajax({
				url : '<%=request.getContextPath()%>/Show/getTeachingdetailByid',
				type : 'GET',
				data:{
						...
						var teaching_context = data.data.teaching_context;
						 document.getElementById('teachingcontext').innerHTML=
							 '<div style="text-align: center;">'+'<h1 class="am-article-title">'+data.data.teaching_titile+'</h1>'+
		 						'<p class="am-article-meta" style="border-bottom: 1px solid #999999;border-top: 1px solid #999999;">'+
		 						'<label style="padding-right: 3%;">作者：'+data.data.teaching_Creater+'</label>'+
		 						'<label style="padding-left: 3%;">时间：'+data.data.teaching_Release_time.slice(0,10)+'</label></div><div>'+teaching_context;
					}
				},
