							...
							<div class="am-cf am-article tableTextAlign">
								<table class="am-table am-table-bordered am-table-radius onlineTable" style="font-size: 14px;">
									...
									<tbody>
										...
										<tr>
											<td class="tableLeftTd2">报名截止日期:</td>
										...
										<tr>
											<td class="tableLeftTd2">咨询联系电话:</td>
											<td class="tableRightTd2" colspan="2">010-34567890</td>
											<!-- <td>2012-10-01</td> -->
										</tr>
										<tr>
											<td class="tableLeftTd2">培训官方通知:</td>
										...
										<tr>
											<td class="tableLeftTd2">报名表格下载:</td>
											<td class="tableRightTd2">请点击下载附件</td>
											<td class="tableRightTd2">
												<a href="../doc/报名表格.zip">附件下载</a>
											</td>
											<!-- <td>2012-10-01</td> -->
										</tr>
										<tr>
											<td class="tableLeftTd2" style="vertical-align: middle;">课程主要大纲:</td>
											<td class="tableRightTd2" colspan="2">
												<!--<textarea>
								...
								<button type="button" class="am-btn am-btn-primary am-round subBtn">
									<a href="" style="color: #FFFFFF;">在线报名</a>
								</button>
							</div>
							<hr />
						</div>
