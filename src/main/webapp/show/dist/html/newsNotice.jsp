...
// 							if(data.success == true){
							...
							for(var i=0;i <datas.length;i++){ 
								zz[i]= '<span class="newsDate">'+datas[i].notice_Release_time+'</span> ●&nbsp;&nbsp;<a href=\"newsNotice_content.jsp?notice_id='+datas[i].notice_id+'\" target="_blank">'+datas[i].notice_titile+'</a>'
						    } //div的字符串数组付给zz
							var pageno=1 ;              //当前页
